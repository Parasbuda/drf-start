...
SECRET_KEY = 'u=d)mn!4_#5+v_8ua!)t2)gwvdf0v=n@*4+7puj36cmbci%kt7'
...
# the created app are defined here and later we concatinate these with the default installed app
PROJECTS_APPS=[
    "languages", 
    "frontend_language"
]
